...
def test_template_has_json_contract() -> None:
    ...
    assert_true('"name": "thanks-subtitle", "x": 460, "y": 437, "w": 520, "h": 36, "text": "HTML Report Stable Base", "fontSize": 16, "pptLevel": "h4", "align": "center"' in html, "embedded JSON must center the thanks subtitle under the title")
